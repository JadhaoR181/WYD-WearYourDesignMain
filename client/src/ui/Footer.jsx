	...
	return (
		<footer className="grid grid-cols-1 md:(grid-cols-3) border-t border-gray-300 bg-gray-200 px-4">
			...
			<h2 className="text-medium text-2xl font-[Poppins],sans-serif">WearYourDesign</h2>
				<p className="text-justify text-gray-700">WearYourDesign is custom printed clothing brand store. users can interact and implement with custom printed according the user Customizations.</p>
			...
			<div className="m-4 sm:m-6">
				...
				<ul className="space-y-3 text-gray-700">
					...
					<li className="flex items-center">
						...
						<span>+91 7620384235</span>
					</li>					
					<li className="flex items-center">
						<Mail className="w-5 h-5 mr-2" />
						<a href="mailto:wearyourdesign@gmail.com" target="_blank">
							wearyourdesign@gmail.com
						</a>
					</li>
