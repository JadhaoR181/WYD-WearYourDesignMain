...
export default function Navbar() {
    ...
    <h2 className="text-medium text-2xl font-[Poppins],sans-serif">WearYourDesign</h2>
    <span className="absolute inset-0 rounded-lg border border-transparent group-hover:border-white group-hover:scale-105 transition-all duration-300 ease-out group-hover:shadow-[0_0_10px_rgba(255,255,255,0.5)]"></span>
</Link>
    ...
    {/* Show the Customization link only if the user is logged in */}
    {user && <NavLink to="/customization">Customization</NavLink>}
</ul>
...
function NavLink({ children, to, external }) {
	return (
